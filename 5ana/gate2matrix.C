...
/*
//input 
TString fInName = "root/g2hist.root";//root file 
TString h2name = "hg2xy_bgsub";//gg-matrix 
//output 
TString fOutName = "root/g2matrix_bgsub.root";//root file
*/

//input 
TString fInName = "root/ddhist.root";//root file 
TString h2name = "hg2xy";//gg-matrix 
//output 
TString fOutName = "root/ddmatrix.root";//root file
