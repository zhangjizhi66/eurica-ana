...
// Tue Nov 13 14:34:47 2012 by ROOT version 5.32/00
// from TTree tree/go4 tree
// found on file: /home/ur12/treefiles/euroball/go4_1012.root
//////////////////////////////////////////////////////////
...
//#include "./include/TArtGeCluster.hh"
//#include "./include/TArtEventInfo.hh"

// Fixed size dimensions of array or collections stored in the TTree if any.
const Int_t kMaxUnpackEvent = 1;
const Int_t kMaxGeCluster = 100;
const Int_t kMaxGeAddback = 100;
//const Int_t kMaxEventInfo = 1;
const Int_t kMaxBigRIPSRaw = 100;
...
public :
   ...
   //new parameters defined by users
      Int_t           grun;   //[EventInfo_]
      ULong64_t       gts;   //[EventInfo_]     
      Int_t           gevt,bgevt;   
      ULong64_t       bgts;   //[EventInfo_]     

      Int_t           ghit;
      Int_t           gid[kMaxGeCluster];   //[GeCluster_]
      UInt_t          gc_DGFe[kMaxGeCluster];   //[GeCluster_]
      UInt_t          gc_DGFt[kMaxGeCluster];   //[GeCluster_]
      UInt_t          gtdcs[kMaxGeCluster];   //[GeCluster_]
      UInt_t          gtdcl[kMaxGeCluster];   //[GeCluster_]
      Double_t        ge[kMaxGeCluster];   //[GeCluster_]
      Double_t        gt[kMaxGeCluster];   //[GeCluster_]
    
      Int_t           ahit;
      Int_t           aid[kMaxGeAddback];   //[GeAddback_]
      UInt_t          ab_DGFe[kMaxGeAddback];   //[GeAddback_]
      UInt_t          ab_DGFt[kMaxGeAddback];   //[GeAddback_]
      UInt_t          atdcs[kMaxGeAddback];   //[GeAddback_]
      UInt_t          atdcl[kMaxGeAddback];   //[GeAddback_]
      Double_t        ae[kMaxGeAddback];   //[GeAddback_]
      Double_t        at[kMaxGeAddback];   //[GeAddback_]    

      Int_t           bghit;
      Int_t           bgid[kMaxGeCluster];   //[GeCluster_]
      UInt_t          bgc_DGFe[kMaxGeCluster];   //[GeCluster_]
      UInt_t          bgc_DGFt[kMaxGeCluster];   //[GeCluster_]
      UInt_t          bgtdcs[kMaxGeCluster];   //[GeCluster_]
      UInt_t          bgtdcl[kMaxGeCluster];   //[GeCluster_]
      Double_t        bge[kMaxGeCluster];   //[GeCluster_]
      Double_t        bgt[kMaxGeCluster];   //[GeCluster_]
    
      Int_t           bahit;
      Int_t           baid[kMaxGeAddback];   //[GeAddback_]
      UInt_t          bab_DGFe[kMaxGeAddback];   //[GeAddback_]
      UInt_t          bab_DGFt[kMaxGeAddback];   //[GeAddback_]
      UInt_t          batdcs[kMaxGeAddback];   //[GeAddback_]
      UInt_t          batdcl[kMaxGeAddback];   //[GeAddback_]
      Double_t        bae[kMaxGeAddback];   //[GeAddback_]
      Double_t        bat[kMaxGeAddback];   //[GeAddback_]
...
eurica::eurica(char* file,TTree *tree) : fChain(0) 
{
...
void eurica::GetTsEntry(map<Long64_t,Long64_t> &mts)
{
   ...
   cout<<"complete ts mapping for Eurica"<<endl;
}

void eurica::GetDecayInfo(Long64_t entry){
   LoadTree(entry);
   fChain->GetEntry(entry);
   gts = EventInfo_timestamp[0];
   gevt=EventInfo_eventnumber[0];
   ghit = GeCluster_;
   //cout<<bevt<<" d "<<gc_hit<<endl;
   memcpy(gid, GeCluster_channel, sizeof(GeCluster_channel));
   memcpy(gc_DGFe, GeCluster_fADCe, sizeof(GeCluster_fADCe));
   memcpy(gc_DGFt, GeCluster_fADCt, sizeof(GeCluster_fADCt));
   memcpy(gtdcs, GeCluster_fTDCs, sizeof(GeCluster_fTDCs));
   memcpy(gtdcl, GeCluster_fTDCl, sizeof(GeCluster_fTDCl));
   memcpy(ge, GeCluster_fEnergy, sizeof(GeCluster_fEnergy));
   memcpy(gt, GeCluster_fTime, sizeof(GeCluster_fTime));
   ahit = GeAddback_;
   memcpy(aid, GeAddback_channel, sizeof(GeAddback_channel));
   memcpy(ab_DGFe, GeAddback_fADCe, sizeof(GeAddback_fADCe));
   memcpy(ab_DGFt, GeAddback_fADCt, sizeof(GeAddback_fADCt));
   memcpy(atdcs, GeAddback_fTDCs, sizeof(GeAddback_fTDCs));
   memcpy(atdcl, GeAddback_fTDCl, sizeof(GeAddback_fTDCl));
   memcpy(ae, GeAddback_fEnergy, sizeof(GeAddback_fEnergy));
   memcpy(at, GeAddback_fTime, sizeof(GeAddback_fTime));
}

void eurica::GetIonInfo(Long64_t entry){
   LoadTree(entry);
   fChain->GetEntry(entry);
   bgts = EventInfo_timestamp[0];
   bgevt=EventInfo_eventnumber[0];
   bghit = GeCluster_;
   //cout<<bevt<<" d "<<gc_hit<<endl;
   memcpy(bgid, GeCluster_channel, sizeof(GeCluster_channel));
   memcpy(bgc_DGFe, GeCluster_fADCe, sizeof(GeCluster_fADCe));
   memcpy(bgc_DGFt, GeCluster_fADCt, sizeof(GeCluster_fADCt));
   memcpy(bgtdcs, GeCluster_fTDCs, sizeof(GeCluster_fTDCs));
   memcpy(bgtdcl, GeCluster_fTDCl, sizeof(GeCluster_fTDCl));
   memcpy(bge, GeCluster_fEnergy, sizeof(GeCluster_fEnergy));
   memcpy(bgt, GeCluster_fTime, sizeof(GeCluster_fTime));
   bahit = GeAddback_;
   memcpy(baid, GeAddback_channel, sizeof(GeAddback_channel));
   memcpy(bab_DGFe, GeAddback_fADCe, sizeof(GeAddback_fADCe));
   memcpy(bab_DGFt, GeAddback_fADCt, sizeof(GeAddback_fADCt));
   memcpy(batdcs, GeAddback_fTDCs, sizeof(GeAddback_fTDCs));
   memcpy(batdcl, GeAddback_fTDCl, sizeof(GeAddback_fTDCl));
   memcpy(bae, GeAddback_fEnergy, sizeof(GeAddback_fEnergy));
   memcpy(bat, GeAddback_fTime, sizeof(GeAddback_fTime));
}
...
void eurica::TreeBranch_Ion(TTree *tree)
{ 
   tree->Branch("bgts",  &bgts,  "bgts/L");
    
   /****** without addback ******/
   tree->Branch("bghit", &bghit, "bghit/I");
   tree->Branch("bgid",  &bgid,  "bgid[bghit]/I");
   tree->Branch("bgtdcs",&bgtdcs,"bgtdcs[bghit]/I");
   tree->Branch("bgtdcl",&bgtdcl,"bgtdcl[bghit]/I");
   tree->Branch("bge",   &bge,   "bge[bghit]/D");
   tree->Branch("bgt",   &bgt,   "bgt[bghit]/D");

   /****** with addback ******/
   tree->Branch("bahit", &bahit, "bahit/I");
   tree->Branch("baid",  &baid,  "baid[bahit]/I");
   tree->Branch("batdcs",&batdcs,"batdcs[bahit]/I");
   tree->Branch("batdcl",&batdcl,"batdcl[bahit]/I");
   tree->Branch("bae",   &bae,   "bae[bahit]/D");
   tree->Branch("bat",   &bat,   "bat[bahit]/D");
}
